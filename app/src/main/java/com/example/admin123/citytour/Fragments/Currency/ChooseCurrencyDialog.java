...
public class ChooseCurrencyDialog extends DialogFragment {
    ...
    CurrencyHashmapAdapter listAdapter;
    ListView listView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_choose_currency, null);
    }

   @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {

        View v = getActivity().getLayoutInflater().inflate(R.layout.fragment_choose_currency, null);
        listView = (ListView) v.findViewById(R.id.currencyListView);
        listAdapter = new CurrencyHashmapAdapter(currenciesCodeMap);
